...
$catalogue = new MessageCatalogue('en', array (
  ...
  'DCSFormSelectCityFormFieldBundle' => 
  array (
    'form.label.country' => 'Country',
    'form.label.country_empty' => 'Select country',
    'form.label.region' => 'Region',
    'form.label.region_empty' => 'Select region',
    'form.label.city' => 'City',
    'form.label.city_empty' => 'Select city',
  ),
  'messages' => 
  array (
    'Bad credentials' => 'Wrong Password my Friend!',
  ),
));
