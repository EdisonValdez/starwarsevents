...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'doctrine.user_listener' => 'getDoctrine_UserListenerService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/starwarsevents/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('C:/wamp/www/starwarsevents/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/wamp/www/starwarsevents/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/starwarsevents/app/Resources');
    ...
    {
        return $this->services['captcha.type'] = new \Gregwar\CaptchaBundle\Type\CaptchaType($this->get('session'), $this->get('gregwar_captcha.generator'), $this->get('translator.default'), array('length' => 5, 'width' => 130, 'height' => 50, 'font' => 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle\\DependencyInjection/../Generator/Font/captcha.ttf', 'keep_value' => false, 'charset' => 'abcdefhjkmnprstuvwxyz23456789', 'as_file' => false, 'as_url' => false, 'reload' => false, 'image_folder' => 'captcha', 'web_path' => 'C:/wamp/www/starwarsevents/app/../web', 'gc_freq' => 100, 'expiration' => 60, 'quality' => 30, 'invalid_message' => 'Bad code value', 'bypass_code' => NULL, 'whitelist_key' => 'captcha_whitelist_key', 'humanity' => 0, 'distortion' => true, 'max_front_lines' => NULL, 'max_behind_lines' => NULL, 'interpolation' => true, 'text_color' => array(), 'background_color' => array(), 'disabled' => false));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), $this->get('doctrine.user_listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'yoda_event', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $c, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_68b9b62a03e3df87baf8c651c92f8f5e0193cd8fd29f0b37c3bf8a3db7fc30f5');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_68b9b62a03e3df87baf8c651c92f8f5e0193cd8fd29f0b37c3bf8a3db7fc30f5');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_68b9b62a03e3df87baf8c651c92f8f5e0193cd8fd29f0b37c3bf8a3db7fc30f5');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\wamp\\www\\starwarsevents\\src\\Yoda\\EventBundle\\Entity', 1 => 'C:\\wamp\\www\\starwarsevents\\src\\Yoda\\UserBundle\\Entity', 2 => 'C:\\wamp\\www\\starwarsevents\\src\\Yoda\\EmailBundle\\Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Yoda\\EventBundle\\Entity');
        $f->addDriver($e, 'Yoda\\UserBundle\\Entity');
        $f->addDriver($e, 'Yoda\\EmailBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('EventBundle' => 'Yoda\\EventBundle\\Entity', 'UserBundle' => 'Yoda\\UserBundle\\Entity', 'EmailBundle' => 'Yoda\\EmailBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('C:/wamp/www/starwarsevents/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'doctrine.user_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Yoda\UserBundle\Doctrine\UserListener A Yoda\UserBundle\Doctrine\UserListener instance.
     */
    protected function getDoctrine_UserListenerService()
    {
        return $this->services['doctrine.user_listener'] = new \Yoda\UserBundle\Doctrine\UserListener($this->get('security.encoder_factory'));
    }

    /**
     * Gets the 'event_report_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Yoda\EventBundle\Reporting\EventReportManager A Yoda\EventBundle\Reporting\EventReportManager instance.
     */
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/starwarsevents/app/Resources');
    }
    ...
    {
        return $this->services['gregwar_captcha.image_file_handler'] = new \Gregwar\CaptchaBundle\Generator\ImageFileHandler('captcha', 'C:/wamp/www/starwarsevents/app/../web', 100, 60);
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/starwarsevents/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/starwarsevents/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/www/starwarsevents/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'C:/wamp/www/starwarsevents/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'yaml'), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $c = $this->get('security.user.provider.concrete.our_database_users');
        ...
        $q = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $o, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($o, 'event'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'logout'));
        $q->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $q->addHandler($p);

        $r = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($o, array('login_path' => 'login_form', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $r->setProviderKey('secured_area');

        $s = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $o, 'secured_area', $r, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $o, array('login_path' => 'login_form', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $s->setRememberMeServices($p);

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($n, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'secured_area', $a, $d), 2 => $q, 3 => $s, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $p, $g, $a, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5556369a76e4a', $a), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $h, $n, $g), 7 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($b, $c, $this->get('security.user_checker'), 'secured_area', $h, $a, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $d)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $o, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $o, 'login_form', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/starwarsevents/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/starwarsevents/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/starwarsevents/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('cookie_lifetime' => 1440, 'gc_probability' => 1), NULL, $this->get('session.storage.metadata_bag'));
    }
     ...
     *
     * @return \Yoda\EventBundle\Admin\EventAdmin A Yoda\EventBundle\Admin\EventAdmin instance.
     */
    protected function getSonata_Admin_EventService()
    {
        $instance = new \Yoda\EventBundle\Admin\EventAdmin('sonata.admin.event', 'Yoda\\EventBundle\\Entity\\Event', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('YodaEventBundle');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.event', 1 => 'sonata.admin.user'));
        $instance->setAdminGroups(array('Content' => array('label' => 'Content', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.admin.event', 1 => 'sonata.admin.user'))));
        $instance->setAdminClasses(array('Yoda\\EventBundle\\Entity\\Event' => array(0 => 'sonata.admin.event'), 'Yoda\\UserBundle\\Entity\\User' => array(0 => 'sonata.admin.user')));
    ...
    {
        return $this->services['sonata.admin.route.cache'] = new \Sonata\AdminBundle\Route\RoutesCache('C:/wamp/www/starwarsevents/app/cache/dev/sonata/admin', true);
    }
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.event', 1 => 'sonata.admin.user'), $this);
    }
     ...
     *
     * @return \Yoda\UserBundle\Admin\UsersAdmin A Yoda\UserBundle\Admin\UsersAdmin instance.
     */
    protected function getSonata_Admin_UserService()
    {
        $instance = new \Yoda\UserBundle\Admin\UsersAdmin('sonata.admin.user', 'Yoda\\UserBundle\\Entity\\User', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('YodaUserBundle');
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
        $instance->setFormContractor($this->get('sonata.admin.builder.orm_form'));
        $instance->setShowBuilder($this->get('sonata.admin.builder.orm_show'));
    ...
    protected function getTemplating_Helper_AssetsService()
    {
        ...
        return $this->services['templating.helper.assets'] = $this->scopedServices['request']['templating.helper.assets'] = new \Symfony\Component\Templating\Helper\CoreAssetsHelper(new \Symfony\Bundle\FrameworkBundle\Templating\Asset\PathPackage($this->get('request'), '5-return-of-the-jedi', '%s?v=%s'), array());
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/starwarsevents/app', 'UTF-8');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/starwarsevents/app/cache/dev/translations', 'debug' => true));

        $instance->setFallbackLocales(array(0 => 'en'));
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.af.xlf', 'af', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ar.xlf', 'ar', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.bg.xlf', 'bg', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ca.xlf', 'ca', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cs.xlf', 'cs', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cy.xlf', 'cy', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.da.xlf', 'da', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.de.xlf', 'de', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.el.xlf', 'el', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.en.xlf', 'en', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.es.xlf', 'es', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.et.xlf', 'et', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.eu.xlf', 'eu', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fa.xlf', 'fa', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fi.xlf', 'fi', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fr.xlf', 'fr', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.gl.xlf', 'gl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.he.xlf', 'he', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hr.xlf', 'hr', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hu.xlf', 'hu', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hy.xlf', 'hy', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.id.xlf', 'id', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.it.xlf', 'it', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ja.xlf', 'ja', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lb.xlf', 'lb', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lt.xlf', 'lt', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.mn.xlf', 'mn', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nb.xlf', 'nb', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nl.xlf', 'nl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.no.xlf', 'no', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pl.xlf', 'pl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt.xlf', 'pt', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt_BR.xlf', 'pt_BR', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ro.xlf', 'ro', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ru.xlf', 'ru', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sk.xlf', 'sk', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sl.xlf', 'sl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sq.xlf', 'sq', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Cyrl.xlf', 'sr_Cyrl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Latn.xlf', 'sr_Latn', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sv.xlf', 'sv', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.th.xlf', 'th', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.tr.xlf', 'tr', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.uk.xlf', 'uk', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.vi.xlf', 'vi', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_CN.xlf', 'zh_CN', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_TW.xlf', 'zh_TW', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ar.xlf', 'ar', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.bg.xlf', 'bg', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ca.xlf', 'ca', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.cs.xlf', 'cs', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.da.xlf', 'da', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.de.xlf', 'de', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.el.xlf', 'el', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.en.xlf', 'en', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.es.xlf', 'es', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.et.xlf', 'et', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.eu.xlf', 'eu', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fa.xlf', 'fa', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fi.xlf', 'fi', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fr.xlf', 'fr', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.gl.xlf', 'gl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.he.xlf', 'he', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hr.xlf', 'hr', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hu.xlf', 'hu', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hy.xlf', 'hy', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.id.xlf', 'id', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.it.xlf', 'it', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ja.xlf', 'ja', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lb.xlf', 'lb', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lt.xlf', 'lt', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lv.xlf', 'lv', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.mn.xlf', 'mn', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nb.xlf', 'nb', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nl.xlf', 'nl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pl.xlf', 'pl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt.xlf', 'pt', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt_BR.xlf', 'pt_BR', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ro.xlf', 'ro', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ru.xlf', 'ru', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sk.xlf', 'sk', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sl.xlf', 'sl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Cyrl.xlf', 'sr_Cyrl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Latn.xlf', 'sr_Latn', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sv.xlf', 'sv', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.uk.xlf', 'uk', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.zh_CN.xlf', 'zh_CN', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.ar.xlf', 'ar', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.ca.xlf', 'ca', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.cs.xlf', 'cs', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.da.xlf', 'da', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.de.xlf', 'de', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.el.xlf', 'el', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.en.xlf', 'en', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.es.xlf', 'es', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.fa.xlf', 'fa', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.fr.xlf', 'fr', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.gl.xlf', 'gl', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.hu.xlf', 'hu', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.it.xlf', 'it', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.lb.xlf', 'lb', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.nl.xlf', 'nl', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.no.xlf', 'no', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.pl.xlf', 'pl', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.pt_BR.xlf', 'pt_BR', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.pt_PT.xlf', 'pt_PT', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.ro.xlf', 'ro', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.ru.xlf', 'ru', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.sk.xlf', 'sk', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.sl.xlf', 'sl', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.sr_Cyrl.xlf', 'sr_Cyrl', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.sr_Latn.xlf', 'sr_Latn', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.sv.xlf', 'sv', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.tr.xlf', 'tr', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../Resources/translations\\security.ua.xlf', 'ua', 'security');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.ar.xliff', 'ar', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.bg.xliff', 'bg', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.ca.xliff', 'ca', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.cs.xliff', 'cs', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.de.xliff', 'de', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.en.xliff', 'en', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.es.xliff', 'es', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.eu.xliff', 'eu', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.fa.xliff', 'fa', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.fr.xliff', 'fr', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.hr.xliff', 'hr', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.hu.xliff', 'hu', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.it.xliff', 'it', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.ja.xliff', 'ja', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.lb.xliff', 'lb', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.lt.xliff', 'lt', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.nl.xliff', 'nl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.pl.xliff', 'pl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.pt.xliff', 'pt', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.pt_BR.xliff', 'pt_BR', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.ro.xliff', 'ro', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.ru.xliff', 'ru', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.sk.xliff', 'sk', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.sl.xliff', 'sl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.uk.xliff', 'uk', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/translations\\SonataAdminBundle.zh_CN.xliff', 'zh_CN', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.ar.xliff', 'ar', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.bg.xliff', 'bg', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.ca.xliff', 'ca', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.cs.xliff', 'cs', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.de.xliff', 'de', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.en.xliff', 'en', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.es.xliff', 'es', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.eu.xliff', 'eu', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.fa.xliff', 'fa', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.fr.xliff', 'fr', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.hr.xliff', 'hr', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.hu.xliff', 'hu', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.it.xliff', 'it', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.ja.xliff', 'ja', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.lb.xliff', 'lb', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.lt.xliff', 'lt', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.nl.xliff', 'nl', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.pl.xliff', 'pl', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.pt.xliff', 'pt', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.pt_BR.xliff', 'pt_BR', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.ro.xliff', 'ro', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.ru.xliff', 'ru', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.sk.xliff', 'sk', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.sl.xliff', 'sl', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.uk.xliff', 'uk', 'SonataCoreBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/translations\\SonataCoreBundle.zh_CN.xliff', 'zh_CN', 'SonataCoreBundle');
        $instance->addResource('xlf', 'C:\\wamp\\www\\starwarsevents\\src\\Yoda\\EmailBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.bg.yml', 'bg', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.cs.yml', 'cs', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.de.yml', 'de', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.en.yml', 'en', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.es.yml', 'es', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.fr.yml', 'fr', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.it.yml', 'it', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.nl.yml', 'nl', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.pl.yml', 'pl', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.pt_BR.yml', 'pt_BR', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.ro.yml', 'ro', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.ru.yml', 'ru', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.uk.yml', 'uk', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\gregwar_captcha.zh_CN.yml', 'zh_CN', 'gregwar_captcha');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.bg.yml', 'bg', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.cs.yml', 'cs', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.de.yml', 'de', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.en.yml', 'en', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.es.yml', 'es', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.fr.yml', 'fr', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.it.yml', 'it', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.nl.yml', 'nl', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.pl.yml', 'pl', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.pt_BR.yml', 'pt_BR', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.ro.yml', 'ro', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.ru.yml', 'ru', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.uk.yml', 'uk', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/translations\\validators.zh_CN.yml', 'zh_CN', 'validators');
        $instance->addResource('yml', 'C:/wamp/www/starwarsevents/app/Resources/translations\\messages.en.yml', 'en', 'messages');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/starwarsevents/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/starwarsevents/app', 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'GregwarCaptchaBundle::captcha.html.twig', 1 => 'form_div_layout.html.twig', 2 => '::form_theme.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    /**
     * Gets the 'twig.event_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Yoda\EventBundle\Twig\EventExtension A Yoda\EventBundle\Twig\EventExtension instance.
     */
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:/wamp/www/starwarsevents/app/Resources/TwigBundle/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\src\\Yoda\\EventBundle/Resources/views', 'Event');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\src\\Yoda\\UserBundle/Resources/views', 'User');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\admin-bundle/Resources/views', 'SonataAdmin');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\core-bundle/Resources/views', 'SonataCore');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\block-bundle/Resources/views', 'SonataBlock');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\sonata-project\\doctrine-orm-admin-bundle/Resources/views', 'SonataDoctrineORMAdmin');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\src\\Yoda\\EmailBundle/Resources/views', 'Email');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle/Resources/views', 'GregwarCaptcha');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/wamp/www/starwarsevents/app/Resources/views');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        $instance->addPath('C:\\wamp\\www\\starwarsevents\\vendor\\knplabs\\knp-menu\\src\\Knp\\Menu/Resources/views');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'C:\\wamp\\www\\starwarsevents\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/starwarsevents/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/starwarsevents/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_BLOG', 1 => 'ROLE_EVENT_CREATE'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_EVENT_CREATE', 2 => 'ROLE_ALLOWED_TO_SWITCH'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.our_database_users'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'UserBundle:User', NULL, NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/starwarsevents/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/www/starwarsevents/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/starwarsevents/app/cache/dev',
            'kernel.logs_dir' => 'C:/wamp/www/starwarsevents/app/logs',
            'kernel.bundles' => array(
                ...
                'EmailBundle' => 'Yoda\\EmailBundle\\EmailBundle',
            ...
            'debug.container.dump' => 'C:/wamp/www/starwarsevents/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/wamp/www/starwarsevents/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/starwarsevents/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/starwarsevents/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/starwarsevents/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/starwarsevents/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/starwarsevents/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/starwarsevents/app/../web',
            'assetic.write_to' => 'C:/wamp/www/starwarsevents/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/starwarsevents/app/cache/dev/doctrine/orm/Proxies',
            ...
            'gregwar_captcha.config' => array(
                ...
                'width' => 130,
                'height' => 50,
                'font' => 'C:\\wamp\\www\\starwarsevents\\vendor\\gregwar\\captcha-bundle\\DependencyInjection/../Generator/Font/captcha.ttf',
                'keep_value' => false,
                ...
                'web_path' => 'C:/wamp/www/starwarsevents/app/../web',
                'gc_freq' => 100,
                'expiration' => 60,
                'quality' => 30,
            ...
            'gregwar_captcha.config.web_path' => 'C:/wamp/www/starwarsevents/app/../web',
