...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Yoda\\EventBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Yoda\\UserBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Yoda\\EmailBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Yoda\\EventBundle\\Entity');
        $c->addDriver($b, 'Yoda\\UserBundle\\Entity');
        $c->addDriver($b, 'Yoda\\EmailBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('EventBundle' => 'Yoda\\EventBundle\\Entity', 'UserBundle' => 'Yoda\\UserBundle\\Entity', 'EmailBundle' => 'Yoda\\EmailBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_891cc5774366b2b8faeb2322565dcff0a6ac5cc03f7ef2e3fc68d5eedd9c0231');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Yoda\\EmailBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Yoda\\EmailBundle/Resources/views'), 'Email');
