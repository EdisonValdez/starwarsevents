...
namespace Proxies\__CG__\Yoda\EventBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Event extends \Yoda\EventBundle\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Yoda\\EventBundle\\Entity\\Event' . "\0" . 'id', '' . "\0" . 'Yoda\\EventBundle\\Entity\\Event' . "\0" . 'name', '' . "\0" . 'Yoda\\EventBundle\\Entity\\Event' . "\0" . 'time', '' . "\0" . 'Yoda\\EventBundle\\Entity\\Event' . "\0" . 'location', '' . "\0" . 'Yoda\\EventBundle\\Entity\\Event' . "\0" . 'details');
        }
